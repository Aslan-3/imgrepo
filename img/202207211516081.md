...
![](F:\KuangStudy\noted\RabbitMQ\image\8.jpg)

谁来生产消息，存储消息和消费消息呢？![](F:\KuangStudy\noted\RabbitMQ\image\9.jpg)
...
![](F:\KuangStudy\noted\RabbitMQ\image\13.jpg)

> 常见的持久化方式

![](F:\KuangStudy\noted\RabbitMQ\image\14.jpg)
...
![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-fQ6t7C7S-1615813808736)(C:\Users\VULCAN\AppData\Roaming\Typora\typora-user-images\image-20210315134437071.png)]](F:\KuangStudy\noted\RabbitMQ\image\15.jpg)

比如我在 APP上下了一个订单，我们的系统和服务很多，我们如何得知这个消息被哪个系统或者哪些服务器或者系统进行消费，那这个时候就需要一个分发的策略。这就需要消费策略。或者称之为消费的方法论

> 场景分析二

![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-l0CNvOUV-1615813808737)(C:\Users\VULCAN\AppData\Roaming\Typora\typora-user-images\image-20210315134747313.png)]](F:\KuangStudy\noted\RabbitMQ\image\16.jpg)
...
![](F:\KuangStudy\noted\RabbitMQ\image\18.jpg)

> 集群模式2 - Master-slave主从同步部署方式

![](F:\KuangStudy\noted\RabbitMQ\image\19.jpg)
...
![](F:\KuangStudy\noted\RabbitMQ\image\20.jpg)

解释：和上面的区别不是特别的大，但是它的写入可以往任意节点去写入

> 集群模式4 - 多主集群转发部署模式

![](F:\KuangStudy\noted\RabbitMQ\image\21.jpg)
...
![在这里插入图片描述](F:\KuangStudy\noted\RabbitMQ\image\23.jpg)
...
![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-WVkC8e8q-1615876872944)(C:\Users\VULCAN\AppData\Roaming\Typora\typora-user-images\image-20210315164044604.png)]](F:\KuangStudy\noted\RabbitMQ\image\24.jpg)

### 03 安装Erlang

> 查看系统版本号

![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-CwebaVkt-1615876872945)(C:\Users\VULCAN\AppData\Roaming\Typora\typora-user-images\image-20210315164402305.png)]](F:\KuangStudy\noted\RabbitMQ\image\25.jpg)
...
![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-avl2IbJW-1615876872947)(C:\Users\VULCAN\AppData\Roaming\Typora\typora-user-images\image-20210315165942974.png)]](F:\KuangStudy\noted\RabbitMQ\image\27.jpg)
...
![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-ExrjWoEy-1615876872950)(C:\Users\VULCAN\AppData\Roaming\Typora\typora-user-images\image-20210315171829104.png)]](F:\KuangStudy\noted\RabbitMQ\image\29.jpg)

### 03小结：


![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-1j3nvTKw-1615876872951)(C:\Users\VULCAN\AppData\Roaming\Typora\typora-user-images\image-20210315172034335.png)]](F:\KuangStudy\noted\RabbitMQ\image\30.jpg)
...
![](F:\KuangStudy\noted\RabbitMQ\image\31.jpg)

> docker的相关命令

![](F:\KuangStudy\noted\RabbitMQ\image\32.jpg)

> 安装rabbitmq

![](F:\KuangStudy\noted\RabbitMQ\image\33.jpg)
...
![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-787v1Med-1615876872953)(C:\Users\VULCAN\AppData\Roaming\Typora\typora-user-images\image-20210315173500241.png)]](F:\KuangStudy\noted\RabbitMQ\image\34.jpg)

> 启动

![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-84RcXU0z-1615876872954)(C:\Users\VULCAN\AppData\Roaming\Typora\typora-user-images\image-20210315173924970.png)]](F:\KuangStudy\noted\RabbitMQ\image\35.jpg)

访问网页，访问成功！

## 4. RabbitMQ的角色分类

![](F:\KuangStudy\noted\RabbitMQ\image\36.jpg)

![](F:\KuangStudy\noted\RabbitMQ\image\37.jpg)
...
![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-78cQpQXh-1615906714913)(C:\Users\VULCAN\AppData\Roaming\Typora\typora-user-images\image-20210315201857946.png)]](F:\KuangStudy\noted\RabbitMQ\image\40.jpg)

### 03 AMQP消费者流转过程

![](F:\KuangStudy\noted\RabbitMQ\image\41.jpg)

## 3. RabbitMQ的核心组成部分

### 01 RabbitMQ的核心组成部分

![](F:\KuangStudy\noted\RabbitMQ\image\43.jpg)

![](F:\KuangStudy\noted\RabbitMQ\image\42.jpg)

### 02 RabbitMQ整体架构是什么样子的？

![](F:\KuangStudy\noted\RabbitMQ\image\44.jpg)

### 03 RabbitMQ的运行流程

![](F:\KuangStudy\noted\RabbitMQ\image\45.jpg)

### 04 RabbitMQ支持的消息模型

![](F:\KuangStudy\noted\RabbitMQ\image\46.jpg)

![](F:\KuangStudy\noted\RabbitMQ\image\47.jpg)
    ...
    public static Runnable runnable = ()->{
        ...
        try {
            ...
            DeliverCallback deliverCallback = (s, delivery)->{
                System.out.println(queueName + "接收到的消息是：" + new String(delivery.getBody(), "UTF-8"));
            };
...
![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-SIuV8TNN-1615906714938)(C:\Users\VULCAN\AppData\Roaming\Typora\typora-user-images\image-20210316085612814.png)]](F:\KuangStudy\noted\RabbitMQ\image\51.jpg)
...
![](F:\KuangStudy\noted\RabbitMQ\image\73.jpg)

## 3. 内存磁盘的监控

###  01 RabbitMQ内存警告

![](F:\KuangStudy\noted\RabbitMQ\image\74.jpg)
...
![](F:\KuangStudy\noted\RabbitMQ\image\75.jpg)

> 配置文件方式 rabbitmq.conf

![](F:\KuangStudy\noted\RabbitMQ\image\76.jpg)

### 03 RabbitMQ的内存换页

![](F:\KuangStudy\noted\RabbitMQ\image\77.jpg)

### 04 RabbitMQ的磁盘预警

![](F:\KuangStudy\noted\RabbitMQ\image\78.jpg)

## 4.  集群

![](F:\KuangStudy\noted\RabbitMQ\image\79.jpg)

### 01 集群搭建

配置的前提是你的 rabbitmq可以运行起来，比如`ps aix|grep rebbitmq`你能看到相关进程，又比如运行`rabbitmqct status`你可以看到类似如下信息而不报错：

![](F:\KuangStudy\noted\RabbitMQ\image\80.jpg)

### 02 单机多实例搭建

![](F:\KuangStudy\noted\RabbitMQ\image\81.jpg)

> 启动第二个节点

![](F:\KuangStudy\noted\RabbitMQ\image\82.jpg)
...
![](F:\KuangStudy\noted\RabbitMQ\image\83.jpg)

> rabbit-2操作作为从节点

![](F:\KuangStudy\noted\RabbitMQ\image\84.jpg)

> 验证集群状态

![](F:\KuangStudy\noted\RabbitMQ\image\85.jpg)
...
![在这里插入图片描述](F:\KuangStudy\noted\RabbitMQ\image\86.jpg)

> 小结

![](F:\KuangStudy\noted\RabbitMQ\image\87.jpg)
...
![image-20210501225839999](F:\KuangStudy\noted\RabbitMQ\image\89.jpg)
...
![image-20210501225752383](F:\KuangStudy\noted\RabbitMQ\image\88.jpg)
...
![image-20210501231747242](F:\KuangStudy\noted\RabbitMQ\image\90.jpg)
...
![image-20210501232113553](F:\KuangStudy\noted\RabbitMQ\image\91.jpg)
...
![](F:\KuangStudy\noted\RabbitMQ\image\92.jpg)

![](F:\KuangStudy\noted\RabbitMQ\image\93.jpg)

#### ①系统与系统之间的分布式事问题

![](F:\KuangStudy\noted\RabbitMQ\image\94.jpg)
...
![](F:\KuangStudy\noted\RabbitMQ\image\95.jpg)

#### ④基于MQ的分布式事务消息的可靠生产问题-定时重发

![](F:\KuangStudy\noted\RabbitMQ\image\96.jpg)

如果这个时候MQ服务器出现了异常和故障，那么消息是无法获取到回执信息。怎么解决呢?

![](F:\KuangStudy\noted\RabbitMQ\image\97.jpg)

#### ⑤基于MQ的分布式事务消息的可靠消费

![](F:\KuangStudy\noted\RabbitMQ\image\98.jpg)

#### ⑥基于MQ的分布式事务消息的消息重发

![](F:\KuangStudy\noted\RabbitMQ\image\99.jpg)
...
![](F:\KuangStudy\noted\RabbitMQ\image\100.jpg)

如果死信队列报错就进行人工处理

![](F:\KuangStudy\noted\RabbitMQ\image\101.jpg)
