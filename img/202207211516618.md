...
| `MSETNX key1 value1 [key2 value2..]` | 批量设置键值对，仅当参数中所有的key都不存在时执行【==原子性操作==，要么一起成功，要么一起失败！】 | 127.0.0.1:6379> MSETNX k1 v1 k4 v4 (integer) 0               |
...
- 对象存储缓存
  ...
  ```bash
  # 对象
  127.0.0.1:6379> mset user:1:name lw user:1:age 23
  OK
...
```
 ...
 ![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210620205520184-1658774703.png)
...
算法原理：[HyperLogLog 算法的原理讲解以及 Redis 是如何应用它的 - 指尖下的幽灵 - 博客园 (cnblogs.com)](https://www.cnblogs.com/linguanh/p/10460421.html)

<img src="https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210620232111182-363302284.png" alt="img"  />
...
![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210620225812611-777973953.png)

 

 ![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210620225932028-1766830271.png)

 ![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210620234956618-882937990.png)

 

 那么如果redis想要实现原子性该怎么处理

加锁

watch  or  setnx

 ![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210621101532883-1473548518.png)

 

 试一下另一个线程修改money但是值不变，看看watch是不是只是解决了cas但是没解决aba问题?
...
![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210622212005375-1262191715.png)

 

 3、![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210622212009960-1820855367.png)

 

 ![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210622212014139-1964470832.png)

 

 ![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210622212019389-1504199509.png)

 

 ![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210622212024604-1209355752.png)

 

 ![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210622212031631-840789191.png)
...
2. Aof运行效率也要比rdb慢，所以我们redis默认的配置就是rdb持久化
   ...
   ![image-20210831104035073](C:\Users\86178\AppData\Roaming\Typora\typora-user-images\image-20210831104035073.png)

3. ![image-20210831104129868](C:\Users\86178\AppData\Roaming\Typora\typora-user-images\image-20210831104129868.png)
...
4. 
   ...
   ![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210622213705331-1395535247.png)
   ...
   ![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210622213720150-333786779.png)
...
![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210622212732123-1297981656.png)
...
![img](https://img2020.cnblogs.com/blog/1363376/202106/1363376-20210622212953368-2049800035.png)
...
如果主机断开了连接，我们可以使用`SLAVEOF no one`让自己变成主机！其他的节点就可以手动连接到最新的主节点（手动）！如果这个时候老大修复了，那么就需要重新连接！
...
- 数字1表示 ：当一个哨兵主观认为主机断开，就可以客观认为主机故障，然后开始选举新的主机。（最低通过的票数）
